    ...
    <form onSubmit={handleSumbit} className="max-w-md mx-auto p-6 space-y-4">
      ...
      <div>
        ...
        <input 
          ...
          className={`w-full px-3 py-2 border rounded-md ${errors.age ? 'border-red-500 bg-red-50' : 'border-gray-300'}`}
        />
      ...
      <button type="submit" className="w-full bg-blue-600 text-white font-medium py-2 rounded-md hover:bg-blue-700 transition">Enviar</button>
    </form>
  )
}
